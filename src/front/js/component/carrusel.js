    ...
    <div className="wrapper">
      <div className="card text-center">
        ...
        <video autoPlay controls>
            <source src="https://ver-videos.s3.eu-central-1.amazonaws.com/90_1006019-1A04118_1B000.mp4" type="video/mp4"/>
        </video>
        </div>
      ...
      <div className="card text-center">
        ...
        <video autoPlay controls muted>
            <source src="https://lv-vod.fl.freecaster.net/vod/louisvuitton/hRV4zHgQnD_HD.mp4" type="video/mp4"/>
        </video>
        </div>
      ...
      <div class="card text-center">
        <div class="image">
        <img src="https://cms-cdn.flightclub.com/375/09f19803f8f5-db78-de11-5b81-0eeb6877.gif" width="300"/>
        </div>
